<template>
    <div class="bg-white">
                                ...
                                <div class="border-b border-gray-200">
                                    <TabList class="-mb-px flex space-x-8 px-4">
                                        <Tab as="template" v-for="category in navigation.categories"
                                            ...
                                            <button
                                                :class="[selected ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-900', 'flex-1 border-b-2 px-1 py-4 text-base font-medium whitespace-nowrap']">{{
        ...
        <header class="relative bg-white">
            ...
            <nav aria-label="Top" class="mx-auto max-w-[1920px] px-4 sm:px-6 lg:px-8">
                <div class="border-b border-gray-200">
